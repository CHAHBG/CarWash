...
export default function AuthLayout() {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            <ScrollView className="bg-[#F7F8FA] h-full" keyboardShouldPersistTaps="handled">
                <View className="px-6 pt-14 pb-10 bg-white rounded-b-[32px] shadow-sm shadow-black/10">
